...
print(id)
source("~/project/OhnishiExtension/JWCode/Data_Simulation_GP2_onevar.R")
p <- 4
saveRDS(list(theta_true, sigma2_true, mu_true, R_long_true, phi_true, psi2_true, 
        ...
        paste0("/home/cim24/project/OhnishiExtension/Results/GP2_4.15_onevar/true_vals", 
               id, ".rds"))
...
for(s in 2:mcmc_samples){
  ...
  if (s %in% c(1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000)){
    print("SAVING")
    #write.csv(cbind(CADE, CASE), "/home/cim24/project/OhnishiExtension/Results/GP2_4.15_onevar/CADE_CASE.csv")
    saveRDS(theta, paste0("/home/cim24/project/OhnishiExtension/Results/GP2_4.15_onevar/theta",
                          id, ".rds"))
    saveRDS(sig2, paste0("/home/cim24/project/OhnishiExtension/Results/GP2_4.15_onevar/sig2",
                         id, ".rds"))
    saveRDS(mu, paste0("/home/cim24/project/OhnishiExtension/Results/GP2_4.15_onevar/mu",
                       id, ".rds"))
    saveRDS(R, paste0("/home/cim24/project/OhnishiExtension/Results/GP2_4.15_onevar/R",
                      id, ".rds"))
    saveRDS(phi, paste0("/home/cim24/project/OhnishiExtension/Results/GP2_4.15_onevar/phi",
                        id, ".rds"))
    saveRDS(psi2, paste0("/home/cim24/project/OhnishiExtension/Results/GP2_4.15_onevar/psi2",
                         id, ".rds"))
    saveRDS(logit_h4, paste0("/home/cim24/project/OhnishiExtension/Results/GP2_4.15_onevar/h4",
                             id, ".rds"))
    saveRDS(logit_l5, paste0("/home/cim24/project/OhnishiExtension/Results/GP2_4.15_onevar/l5",
                             id, ".rds"))
    saveRDS(logit_h6, paste0("/home/cim24/project/OhnishiExtension/Results/GP2_4.15_onevar/h6",
                             id, ".rds"))
    saveRDS(logit_l6,paste0("/home/cim24/project/OhnishiExtension/Results/GP2_4.15_onevar/l6",
                            id, ".rds"))
    saveRDS(gamma, paste0("/home/cim24/project/OhnishiExtension/Results/GP2_4.15_onevar/gamma",
                          id, ".rds"))
    saveRDS(Pi, paste0("/home/cim24/project/OhnishiExtension/Results/GP2_4.15_onevar/Pi",
                       id, ".rds"))
    saveRDS(delta, paste0("/home/cim24/project/OhnishiExtension/Results/GP2_4.15_onevar/delta",
                       id, ".rds"))
    saveRDS(tau2, paste0("/home/cim24/project/OhnishiExtension/Results/GP2_4.15_onevar/tau2",
                       id, ".rds"))
    saveRDS(list(acctot_phi, acctot_gamma, acctot_h4, acctot_l5, acctot_h6, acctot_l6),
            paste0("/home/cim24/project/OhnishiExtension/Results/GP2_4.15_onevar/acctots", 
                   id, ".rds"))
  }
}
