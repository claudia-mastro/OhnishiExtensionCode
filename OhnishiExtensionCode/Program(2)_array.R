...
CADE.bias <- (CADE.true - median(CADE[50000:100000], na.rm=TRUE))/CADE.true * 100
CASE.bias <- (CASE.true - median(CASE[50000:100000], na.rm=TRUE))/CASE.true * 100
CADE.se <- sd(CADE[50000:100000], na.rm=TRUE)
CASE.se <- sd(CASE[50000:100000], na.rm=TRUE)

write.csv(cbind(CADE.bias, CASE.bias, CADE.se, CASE.se), paste0("/home/cim24/project/OhnishiExtension/Results/JWCode_500_100k_", id, ".csv"))
