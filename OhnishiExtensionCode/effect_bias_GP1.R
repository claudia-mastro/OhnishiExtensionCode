...
Gid <- readRDS(paste0("~/palmer_scratch/OhnishiExtension/Results/", v, "/G", id, ".rds"))
h0id <- readRDS(paste0("~/palmer_scratch/OhnishiExtension/Results/", v, "/h4", id, ".rds"))
l0id <- readRDS(paste0("~/palmer_scratch/OhnishiExtension/Results/", v, "/l5", id, ".rds"))
h1id <- readRDS(paste0("~/palmer_scratch/OhnishiExtension/Results/", v, "/h6", id, ".rds"))
l1id <- readRDS(paste0("~/palmer_scratch/OhnishiExtension/Results/", v, "/l6", id, ".rds"))
betaid <- readRDS(paste0("~/palmer_scratch/OhnishiExtension/Results/", v, "/beta", id, ".rds"))
sigma2id <- readRDS(paste0("~/palmer_scratch/OhnishiExtension/Results/", v, "/sig2", id, ".rds"))


bias_CADE <- rep(NA, length(iters))
bias_CASE <- rep(NA, length(iters))
j <- 0
ests <- matrix(NA, nrow=2, ncol=length(iters))
for (i in iters) {
  print(i)
  j <- j+1
...
saveRDS(ests[1,], paste0("~/palmer_scratch/OhnishiExtension/Results/", v, "/CADE", id, ".rds"))
saveRDS(ests[2,], paste0("~/palmer_scratch/OhnishiExtension/Results/", v, "/CASE", id, ".rds"))